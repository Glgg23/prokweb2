            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('kelurahan/edit/'.$kelurahan->id)}}"><button class="btn btn-warning">Edit</button></a> 
                    <a href="{{ url('kelurahan/delete/'.$kelurahan->id)}}"><button class="btn btn-danger">Hapus</button></a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
