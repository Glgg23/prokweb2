        ...
        <div class="card-body">
                ...
                <form action="{{url('kelurahan/update/'.$kelurahan->id)}}" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="{{ $kelurahan->nama }}" id="nama" name="nama" required>
                      </div>
                      <div class="form-group">
                          <label for="kecamatan">Kecamatan</label>
                          <input type="text" class="form-control" value="{{ $kelurahan->kecamatan }}" id="kecamatan" name="kecamatan" required>
                      </div>
                      <div class="form-group">
                          <br>
