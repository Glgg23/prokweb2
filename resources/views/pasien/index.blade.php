                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('pasien/detail/'.$pasien->id)}}">
                      ...
                      onclick="return confirm('Detail pasien bernama {{ $pasien->nama }}')">Detail</button></a>
                    <a href="{{ url('pasien/edit/'.$pasien->id)}}"><button class="btn btn-warning">Edit</button></a> 
                    <a href="{{ url('pasien/delete/'.$pasien->id)}}">
                      <button class="btn btn-danger"
                      onclick="return confirm('Hapus nama pasien bernama {{ $pasien->nama }}')">Hapus</button></a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
